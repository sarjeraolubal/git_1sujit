...
?><html>
  ...
  <body>
    ...
    <h1>Display Vessel Costing Report  </h1>
		...
		<label>Vessel Code </label><input type="text" name="vm_code"/>
...
//require "dist/lib/dataextrfunc.php";
	   ...
	   //  function mysql_escape_string($string){return mysqli_escape_string($string);}
        ...
        if((isset($_POST['year']))||(isset($_POST['vm_code']))||(isset($_POST['comp_code']))){
		if($_POST['year']==""){$post_year='%';}else {$post_year=$_POST['year'];}
		if($_POST['comp_code']==""){$post_comp_code='%';}else {$post_comp_code=$_POST['comp_code'];}
		if($_POST['vm_code']==""){$post_vm_code='%';}else {$post_vm_code=$_POST['vm_code'];}

		//$selecteddata_list = search_datalist();

		$selecteddata_list = search_datalist($post_year,$post_comp_code,$post_vm_code);
    ...
    <?php
          ...
          function search_datalist($post_year,$post_comp_code,$post_vm_code){
...
GROUP BY lp_dc_wdtl.wtm_code,
 ...
 HAVING	lp_dc_pri_inf.sys_co_code like '".$post_comp_code."'  AND  date_format(lp_dc_pri_inf.dwd_date,'%Y%m')    like '".$post_year."' AND vm_code like '".$post_vm_code."'		
