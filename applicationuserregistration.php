...
<div align="right">
    ...
    <label for="ROLE" id="label_role" class="col-md-4 control-label">ROLE  <font color="red">*</font></label>
    <div class="col-md-7">
    <input type="text" name="role" id="role" class="form-control" required   style="width:150px" maxlength="50" value="<?php echo !empty($role)?$role:'';?>" />
    </div>
