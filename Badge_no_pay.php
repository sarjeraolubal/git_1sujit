...
//require "dist/lib/dataextrfunc.php";
	   ...
	   //  function mysql_escape_string($string){return mysqli_escape_string($string);}
         ...
         GLOBAL $List_Pay_MASTER, $post_year,$post_badge_no,$post_comp_code;
...
//-- List of  db table	 
 ...
 function Total_Pay_M($badge_no_w,$badge_no,$sumamount) 
    ...
    function List_Pay_M()
	{
      ...
      echo "<th>Co<br/>CD</th>  <th> Badge <br/>(No.)</th>   <th> Gang <br/>Code</th> <th> Name </th>  <th> Matha </th>
	  <th> men<br/>(No.) </th><th> Total<br/>Amount </th>   <th>Slip<br/> Number</th> <th> Date </th> <th> Wrk<br/> CD </th><th> Work Type </th><th> bags </th><th> Rate </th><th> Total<br/> amount </th><th> vsl<br/> cd </th>
...
/*		   $dayamount        = 0;
      ...
      {
                global  $wtm_code_w,$wtm_code ;
                global $badge_no_w,$badge_no;
                global $sumamount;
