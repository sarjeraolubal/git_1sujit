...
//-- List of  db table	 
	...
	
	{
        ...
        global $badge_no, $badge_no_w;
        global  $wtm_code_w,    $slip_no;
		global	   $slip_no_w;
		 
	     $badge_no_w = 	$selecteddata_list[0][0]; 
		 $slip_no_w  = 	$selecteddata_list[0][4];
		 $wtm_code_w = 	$selecteddata_list[0][8];
         $slip_no_w  =  0; 
         $badge_no_w =  0;   
      ...
      echo "<th>Co<br/>CD</th>  <th>Slip<br/> Number</th> <th> Date </th> <th> Badge <br/>(No.)</th>   <th> Gang <br/>Code</th> <th> Name </th>  <th> Matha </th>
	  <th> men<br/>(No.) </th><th> Total<br/>Amount </th>   <th> Wrk<br/> CD </th><th> Work Type </th><th> bags </th><th> Rate </th><th> Total<br/> amount </th><th> vsl<br/> cd </th>
...
/*		   $dayamount        = 0;
      ...
      {
                global $slip_no_w,  $badge_no_w;
                global $slip_no, $badge_no;
                global $sumamount;
	          global $gang_code_w;
		       $gang_code_w ='';
				...
				if  ($slip_no_w  == $slip_no) 
					
					{
				       ...
				       IF  ($gang_code_W ==  $gang_code)		
				   
				    {   
					
					  IF  ($wtm_code_W !=  $wtm_code)
