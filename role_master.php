...
<div align="right">
	...
	<label for="role Code" id="label_sys_co_code" class="col-md-4 control-label">Role Code</label>
	<div class="col-md-7">
	...
	<label for="role Name" id="label_sys_co_name" class="col-md-4 control-label">Role Name <font color="red">*</font></label>
	<div class="col-md-7">
		...
		$.ajax({
			...
			success: function(responseResult){
				if (responseResult != 0){
					...
					document.rolemaster.sys_co_code.focus();}
			}
		});
	}
	</script>
